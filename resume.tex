...
{\blocking
  ...
  From my several years industry experience and degree from Western Washington University,
...
\item IR system with for Subject Matter Expert Identification Topic and Author modeling system
\end{**mylist}

\begin{**mylist}{Fair Neuroimaging Lab \tabb Research Engineer}{Oct. 2017 - present}
\item Developed low overhead workflows and analytics tools for studying Microbiomes
...
\item \LU{Python, Bash, R, neo4j}


  =======
\begin{**mylist}{NASA Jet Propulsion Lab\tabb Research Fellow}
\item Information retrieval on automatic identification of Subject Matter Experts
>>>>>>> 6b5026c5256eb4b1d48e9657b286651f6c24b553
\end{**mylist}
