...
\begin{**mylist}{NASA Jet Propultion Lab \tabb Summer Research Fellow}{June 2018 - Sept. 2018}
\item Developed IR system for Subject Matter Expert Identification against failure reports
%\item Assesed topic models for documents with multiple sized free text fields
\item Developed principled text normalization and tokenization evaluation strategies
\end{**mylist}
