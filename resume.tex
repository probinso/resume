...
{\blocking
  ...
  I developed strong interests in information retrieval,
  machine learning, programming languages, and reproducible research. I
  %am a very quick study, as I have adopted
  have adapted to, and adopted, a new or tool-set in nearly every
...
\item Developed Subject Matter Expert (SME) recomender, by extending the \href{https://mimno.infosci.cornell.edu/info6150/readings/398.pdf}{Author-Topic-Model} % against failure report system
\item Developed UX specifications from meetings with top JPL employees
...
\item Topic modeling and applications for non-statisticians\hfill\LUx{\LaTeX, Python}
...
\item Distributed Fully Homomorphic Encryption System \hfill\LUx{Hadoop, Sagemath, Python}
