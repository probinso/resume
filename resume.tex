...
\item Developed lamp classification engine, photo image processing tools, and mathematical models
\item Developed a memoizing database-interface for caching expensive operations
%\item Provided hands on training to grow industry scientists in Python
\item \hspace{-1em}
  {\bf{ComScore}}\hfill{\bf{June 2016 - present}}
\item Worked to support large, custom, memory mapped, data store for analysis of television viewer demographics
\item \hspace{-1em}
