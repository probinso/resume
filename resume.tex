...
\end{comment}
{\blocking
  I am currently a graduate student at Oregon Health and Sciences University,
  studying computer science with interest in computational statistics.
  From  my 5 years industry expirience and BS at Western Washington University,
  I developed strong interests in cryptography, statistical computing, and
...
\item Developed data aggrigation/processing pipeline for reported data and FMRI images
\item Worked in teams under multiple institutional review boards
\item \LU{Python, Bash, LabKey}
\end{**mylist}

\begin{**mylist}{Independent \tabb Contractor/Consultant}{}
\item \hspace{-1em}
  \href{http://cwenergyusa.com/star-friendly/}{\bf{C\&W Energy USA}}\hfill{\bf{Nov. 2015 - Oct. 2017}}
...
\item Relivance Vector Machine \hfill\LUx{Julia}
...
%\item Gradient Descent on Arbitrary Degree Hyperplanes\hfill\LUx{Julia}
