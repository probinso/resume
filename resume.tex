...
\end{comment}
{\blocking
  I am presently a graduate student at Oregon Health and Sciences University.
  ...
  statistical computing, and languages. I am a very quick study,
  as I have adopted a new programming language or tool-set in nearly every
...
\item[$\star$] Machine Learning
\item[$\star$] Information Retrieval
\item[$\star$] Ethics of Machine Learning
...
\begin{mylist}{Elective Courses :}{2}
...
\item Sensor Systems and Light Pollution Course\hfill\LUx{aws, sklearn, scipy, PonyORM, Python}
