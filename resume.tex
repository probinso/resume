...
\item Designed prototype system from meetings with top NASA employees, in mission risk assesment
\item Developed Subject Matter Expert identier, by extending the Author-Topic-Model % against failure report system
\item Implemented principled text normalization, tokenization, and model evaluation strategies
