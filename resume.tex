...
{\blocking
  ...
  studying computer science with interest in image processing and machine learning.
...
x\BSec{Neato Projects}
\small
\vspace{-.08in}\begin{**mylist}{}{}
\item Sensor Systems and Light Pollution Analysis\hfill\LUx{aws, sklearn, skimage, PonyORM, Python}
\item \href{https://github.com/probinso/morphological-watersheds}{High Performance Morphological Watershedding Algorithms}\hfill\LUx{numpy, ndimage, Python}
