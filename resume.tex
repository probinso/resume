...
{\blocking
  I am soon completing a masters degree, with 7+ years industry experience solving
  increasingly difficult problems with
  ...
  and computer securities, as well as audio, image, and text processing. I have
  developed strong interests in data analysis/exploration, information retrieval,
  machine learning, and data engineering. %I look forward to understanding and
  ...
  {\em (complete work history on request)}
}
\begin{comment}
{\blocking
...
\item Fully specified programatic solution from use-case meetings with top NASA/JPL employees
...
\item Implemented stable/principled normalization, tokenization, and evaluation for NLP topic models
...
\item  Acted as stadards and Open Source release lead, developing and enforcing best practices
