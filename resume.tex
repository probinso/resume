...
\item Open Source contributions to the gensim's natural language processing library
...
\item \LU{Python, R, AWS, PostgreSQL, Perl, C++, skimage, AWS, Jira, ZenHub}
\end{**mylist}
...
\item \href{https://github.com/probinso/introduction-git}{Workshop collaborative introduction to GitHub} and \href{https://github.com/probinso/ABC}{slides}\hfill\LUx{markdown, bash, githhub.api}
