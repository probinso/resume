...
{\blocking
  ...
  I am hoping to help you understand, and better yet solve, interesting and valuable problems.
}
...
\begin{**mylist}{NASA Jet Propulsion Lab \tabb Graduate Research Intern}{June 2018 - Sept. 2018}
...
\item \LU{Python, gensim, pyLDAvis, pandas, jupyter}
\end{**mylist}
...
\item Developed low cost spectral profile analysis and custom photo image processing
...
\item \href{https://github.com/probinso/expert-modeling-system/blob/master/decks/itds/pres.pdf}{Topic modeling and applications, for non-statisticians}\hfill\LUx{\LaTeX}
\item \href{https://github.com/probinso/Whales}{Whale vocals localization and analysis}\hfill\LUx{scipy, Python}
...
\item[$\star$] Deep Learning
\item[$\star$] Artificial Intelligence
