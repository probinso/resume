...
{\blocking
  I have 7+ years experience, solving increasingly difficult
  problems with software. My projects span products and research
  including data pipelines/management, medical informatics, programming
  languages, computer securities, audio, image, and text processing. I
  have developed strong interests in scientific computing, information
  retrieval, machine learning, and education. %I am a native to computing,
  %and have successfully adopted new technologies/languages in nearly
  %every project I have worked on.
  I look forward to building stable
  solutions with you.
  %I have adapted to, and adopted, a new tool-set in nearly every challenge I have taken on.
}
\begin{comment}
{\blocking
...
\begin{mylist}{Persistant Experience :}{4}
\item Python
%\item Ada
%\item Julia
\item R, dplyr
...
\begin{**mylist}{\href{www.thinkful.com}{Thinkful} \tabb Data Science Techichal Expert}{Jan. 2019 - present}
...
%\item Developed and specified program from meetings with top JPL employees
\item Implemented stable/principled text normalization, tokenization, and model evaluation
%\item Readied project for adoption and technology transfer
...
\item \LU{Python, Bash, R, neo4j, ponyorm, stan, GitLab}
\end{**mylist}

\begin{**mylist}{Contractor/Consultant (Part Time)}{}
\item \hspace{-1em}
  {\bf{RGB Optics} / }\href{http://cwenergyusa.com/star-friendly/}{\bf{C\&W Energy USA}}\hfill{\bf{Nov. 2015 - Aug. 2018}}
...
\item \href{https://github.com/probinso/expert-modeling-system/blob/master/decks/itds/pres.pdf}{Topic modeling and applications, a presentation for non-statisticians}\hfill\LUx{\LaTeX}
...
\item \href{https://github.com/probinso/morphological-watersheds}{Morphological Watershedding Algorithms}\hfill\LUx{pyspark, numpy, ndimage, Python}
...
\item 2016 - present\hfill {\em Expected End: Sept. 2019}
\end{*mylist}
